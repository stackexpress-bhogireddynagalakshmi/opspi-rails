  ...
  module OrderDecorator
    ...
    def find_order_by_token_or_user(options = {}, with_adjustments = false)
      ...
      if order.nil? && spree_current_user.present?
        ...
        order = TenantManager::TenantHelper.unscoped_query do
          spree_current_user.orders.incomplete.find_by_token(token_order_params[:token])
        end
      end
    ...
    def current_order_params
      order_data = { currency: current_currency, token: cookies.signed[:token],
                     user_id: try_spree_current_user.try(:id), store_id: get_current_store_id }
    ...
    def get_current_store_id
      if current_store.present?
        ...
        raise StandardError, "Store Not Found"
      end
    end
  end
end

if ::Spree::Core::ControllerHelpers::Order.included_modules.exclude?(::ControllerHelpers::OrderDecorator)
  ::Spree::Core::ControllerHelpers::Order.prepend ::ControllerHelpers::OrderDecorator
end
