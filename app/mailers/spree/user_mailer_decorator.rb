module Spree
  module  UserMailerDecorator 
    ...
    def confirmation_instructions(user, token, _opts = {})
      ...
      @email = user.email
      mail to: user.email, from: @current_store.mail_from_address, subject: @current_store.name + ' - Confirmation Instructions for Control Panel ' + I18n.t(:subject ,scope: [:devise, :mailer]), store_url: @current_store.url
    end  
